        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="<?= BASE_URL_ADMIN . '?act=forminsertphong' ?>"><button class="btn btn-success">Thêm phòng</button></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  <?php foreach ($allphong as  $key => $phong) { ?>
                    <tr>
                      ...
                      <td><a href="<?= BASE_URL_ADMIN . '?act=formupdatephong&id=' . $phong['id'] ?>"><button class="btn btn-warning">Sửa</button></a>
                        <a href="<?= BASE_URL_ADMIN . '?act=deletephong&id=' . $phong['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')"><button class="btn btn-danger">Xóa</button></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
