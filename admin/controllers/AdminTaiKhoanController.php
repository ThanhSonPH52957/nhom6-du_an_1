<?php
    class AdminTaiKhoanController {
        ...
        function formInsertQuanTri() {
            require_once './views/taikhoan/taikhoan/addQuanTri.php';
        ...
        function insertQuanTri() {
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if(empty($errors)) {
                    ...
                    header("location:".BASE_URL_ADMIN.'?act=listtaikhoantaikhoan');
                    exit();
                } else {
        ...
        function formUpdatetaikhoan() {
            $id_quan_tri = $_GET['id'];
            $quantri = $this -> modelTaiKhoan -> getOneTaiKhoan($id_quan_tri);

            require_once './views/taikhoan/taikhoan/updateQuanTri.php';
        ...
        function updateQuanTri() {
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if(empty($errors)) {
                    ...
                    header("location:".BASE_URL_ADMIN.'?act=formupdatetaikhoan&id='.$id_quan_tri);
                    exit();
                }
            }
        }
